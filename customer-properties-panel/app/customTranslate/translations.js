...
export default {
    ...
    'General': '通用',
    'Name': '名称(Name)',
    'Version Tag': '版本号(Version Tag)',
    'Executable': '是否可执行(Executable)',
    'External Task Configuration': '外部任务配置(External Task Configuration)',
    'Task Priority': '任务优先级(Task Priority)',
    'Job Configuration': '工作配置(Job Configuration)',
    'Job Priority': '工作优先级(Job Priority)',
    'Documentation': '文档(Documentation)',
    'Element Documentation': '元素文档(Element Documentation)',
    'History Configuration': '历史配置(History Configuration)',
    'History Time To Live': '历史生存时间(History Time To Live)',
    'Listeners': '监听器',
    'Execution Listener': '执行监听器(Execution Listener)',
    'Event Type': '事件类型(Event Type)',
    'Listener Type': '监听器类型(Listener Type)',
    'Must provide a value': '请提供值(Must provide a value)',
    'Field Injection': '字段注入(Field Injection)',
    'Fields': '字段(Fields)',
    'Type': '类型(Type)',
    'Value': '值(Value)',
    ...
    'Script': 'Script(脚本)',
    'Inline Script': '内联样式(Inline Script)',
    'External Resource': '外部资源(External Resource)',
    'Properties': '属性(Properties)',
    'Add Property': '添加属性(Add Property)',
    'Extensions': '扩展',
    'Input/Output': '输入输出',
    'Parameters': '参数(Parameters)',
    'Input Parameters': '输入参数(Input Parameters)',
    'Output Parameters': '输出参数(Output Parameters)',
    'Asynchronous Continuations': '异步扩展(Asynchronous Continuations)',
    'Asynchronous Before': '异步之前(Asynchronous Before)',
    'Asynchronous After': '异步之后(Asynchronous After)',
    'Retry Time Cycle': '重试时间周期(Retry Time Cycle)',
    'Exclusive': '是否专有(Exclusive)',

    'Details': '详情(Details)',
    'Assignee': '代理人(Assignee)',
    'Candidate Users': '候选用户(Candidate Users)',
    'Candidate Groups': '候选用户组(Candidate Groups)',
    'Due Date': '截止日期(Due Date)',
    'Follow Up Date': '跟进日期(Follow Up Date)',
    'Priority': '优先级(Priority)',
    'The due date as an EL expression (e.g. ${someDate} or an ISO date (e.g. 2015-06-26T09:54:00)': '截止日期的格式为EL表达式(${someDate})或者ISO日期格式(2015-06-26T09:54:00)',
    'The follow up date as an EL expression (e.g. ${someDate} or an ISO date (e.g. 2015-06-26T09:54:00)': '跟进日期的格式为EL表达式(${someDate})或者ISO日期格式(2015-06-26T09:54:00)',
    'Implementation': '实现(Implementation)',
    'Message': '消息(Message)',
    'Message Name': '消息名称(Message Name)',
